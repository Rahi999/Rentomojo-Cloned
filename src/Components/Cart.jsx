...
const Cart = () => {
     ...
     const getCart = () => {
        axios.get("https://json-server-mocker-myapi.herokuapp.com/cart")
   ...
   const handleDelete = (id) => {
    axios.delete(`https://json-server-mocker-myapi.herokuapp.com/${id}`)
    .then((res)=> {
          getCart()
          toast({
            title: 'Item Deleted.',
...
<SimpleGrid style={{width:"90%",margin:"auto",marginTop:"4%",gap:'2%'}} columns={{
    ...
    <Box height={{sm:"600px",md:"550px",lg:"500px",xl:"500px",base:"450px"}} style={{padding:'10%',borderRadius:"8px",backgroundColor:"white",width:"110%"}}>
       <Box style={{display:"flex",}}>
        <Img width="7%" src="https://www.rentomojo.com/public/images/radical-cart/icons/summary__icon.svg" />
        <Text style={{fontWeight:"bold"}} fontSize={{sm:"15px",md:"18px",lg:"19px",xl:"20px",base:"14px"}}>Order Sumarry</Text>
       </Box>
       ...
       <SimpleGrid columns={{sm:1,md:2,lg:2,xl:2,base:1}} style={{marginTop:"4%",justifyContent:"space-evenly",}}>
        <Box style={{border:"1px solid #e2eaf0",width:"90%", padding:'2%',borderRadius:"8px",marginTop:"2%"}}>
    ...
    <Box style={{height:"100%",borderRadius:"8px",width:"90%"}}>
        <Box style={{display:"flex",borderRadius:"8px",backgroundColor:"white",width:"80%",margin:"auto",justifyContent:"space-evenly",padding:"3%"}}>
            ...
            <Box  style={{borderRadius:"8px",backgroundColor:"white",width:"80%",margin:"auto",marginTop:"5%",padding:"3%"}}>
               <Box style={{width:"80%",textAlign:"center",margin:"auto",backgroundColor:"#dc3226",color:"white",borderRadius:"5px"}}>
                <Text fontSize={{sm:"13px",md:"14px",lg:"15px",xl:"16px",base:"12px"}}>Only few left in stock. Hurry up!</Text></Box>

            </Box>
            
            {cartData && cartData.map((item)=> (
                <Box key={item.length} style={{width:"80%",margin:"auto",backgroundColor:"white",borderRadius:'8px'}}>
            ...
            <SimpleGrid columns={{sm:1,md:1,lg:2,xl:2,base:1}} style={{backgroundColor:"white",width:"60%",margin:"auto"}}>
                <Select onChange={(e)=> setQuantity(e.target.value)} style={{width:"100%"}} style={{marginTop:"2%"}} fontSize={{sm:"13px",md:"14px",lg:"15px",xl:"16px",base:"12px"}}>
                ...
                <Select style={{width:"100%"}} style={{marginTop:"2%"}} fontSize={{sm:"13px",md:"14px",lg:"15px",xl:"16px",base:"12px"}}>
            ...
            <Box style={{backgroundColor:"#e2eaf0",padding:"2%",marginTop:"4%",width:"100%",margin:"auto",display:"flex",justifyContent:"space-evenly"}}>
               <Img width="8%" src="https://www.rentomojo.com/public/images/radical-cart/icons/truck__icon.svg" />
               <Text fontSize={{sm:"14px",md:"16px",lg:"17px",xl:"19px",base:"12px"}}>Deleivery By {date}/{month}/{year}</Text>
            </Box>
                </Box>
            ))}
    </Box>
